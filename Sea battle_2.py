...
if __name__ == '__main__':
    ...
    players.append(Player(name='IQ', is_ai=True, auto_ship=True, skill=1))
    ...
    while True:
        ...
        if game.status == 'in game':
            ...
            Game.clear_screen()
            game.current_player.message.append("Ваш ход: ")
            game.draw()
            ...
            if shot_result == 'miss':
                ...
                game.current_player.message.append('Продолжайте!')
                game.next_player.message.append('Наш корабль обстреливают!')
                continue
